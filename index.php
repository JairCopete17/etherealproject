<html lang="es">
  ...
  <body>
      ...
      <nav>
        ...
        <ul class="header-control">
          ...
          <li class="header-control_special">
            <a href="#signin"><img src="./images/Profile.svg" alt="Profile" class="header-control_icons">Iniciar sesión</a>
    ...
    <section class="hero">
      ...
      <h1 class="hero-title">Inicia tu camino al <span class="text-gradient">Metaverso</span></h1>
    </section>
    <section class="cards">
